...
Stat.create(name: 'Strikeouts', abbreviation: 'K', unique_identifier: 'strikeouts')
...
Stat.create(name: 'Walks', abbreviation: 'BB', unique_identifier: 'walks')
Stat.create(name: 'Scarifices', abbreviation: 'SAC', unique_identifier: 'sacrifices')
